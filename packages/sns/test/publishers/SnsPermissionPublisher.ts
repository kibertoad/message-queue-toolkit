...
import type { SNSDependencies, NewSNSOptions, ExistingSNSOptions } from '../../lib/sns/AbstractSnsService'
...
export class SnsPermissionPublisher extends AbstractSnsPublisher<PERMISSIONS_MESSAGE_TYPE> {
  ...
  constructor(
    ...
    options:
        | Pick<NewSNSOptions<PERMISSIONS_MESSAGE_TYPE>, 'queueConfig'>
        | Pick<ExistingSNSOptions<PERMISSIONS_MESSAGE_TYPE>, 'queueLocator'> = {
      queueConfig: {
