...
export const SNS_MESSAGE_MAX_SIZE = 220 * 1024 // 220KB to leave some extra space for message attributes, in order not to exceed 256KB total message size limit
